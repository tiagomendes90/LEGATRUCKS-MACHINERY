        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <Link to="/trucks" className="text-center group cursor-pointer">
              <div className="w-48 h-48 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 bg-orange-100 group-hover:bg-orange-300 group-hover:scale-110 group-hover:shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-24 w-36 transition-transform duration-300 group-hover:scale-110">
              ...
              <h3 className="font-semibold text-lg mb-2 group-hover:text-orange-500 transition-colors duration-300">TRUCKS</h3>
            ...
            <Link to="/machinery" className="text-center group cursor-pointer">
              <div className="w-48 h-48 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 bg-blue-200 group-hover:bg-blue-300 group-hover:scale-110 group-hover:shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-24 w-36 transition-transform duration-300 group-hover:scale-110">
              ...
              <h3 className="font-semibold text-lg mb-2 group-hover:text-orange-500 transition-colors duration-300">MACHINERY</h3>
            ...
            <Link to="/agriculture" className="text-center group cursor-pointer">
              ...
              <h3 className="font-semibold text-lg mb-2 group-hover:text-orange-500 transition-colors duration-300">TRACTORS</h3>
            ...
            <Link to="/contact" className="text-center group cursor-pointer">
              <div className="w-48 h-48 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 bg-blue-200 group-hover:bg-blue-300 group-hover:scale-110 group-hover:shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 32" className="h-24 w-36 transition-transform duration-300 group-hover:scale-110">
              ...
              <h3 className="font-semibold text-lg mb-2 group-hover:text-orange-500 transition-colors duration-300">WANT TO SELL?</h3>
