        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mb-6 flex justify-between items-center">
            <p className="text-gray-600">
              ...
              {totalPages > 1 && <span className="ml-2 text-gray-500">
          ...
          {currentTrucks.length > 0 ? <>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                {currentTrucks.map(truck => <Card key={truck.id} className="group hover:shadow-xl transition-all duration-300 overflow-hidden">
                    <div className="relative overflow-hidden">
                      <img src={truck.images && truck.images.length > 0 ? truck.images[0] : "https://images.unsplash.com/photo-1487887235947-a955ef187fcc?w=500&h=300&fit=crop"} alt={truck.model} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" />
                    ...
                    <CardContent>
                      <div className="space-y-2 mb-6">
                        {truck.features && truck.features.length > 0 ? truck.features.slice(0, 4).map((feature, index) => <div key={index} className="flex items-center text-sm text-gray-600">
                            ...
                            {truck.horsepower && <div className="flex items-center text-sm text-gray-600">
                                <span className="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                                {truck.horsepower} HP
                              </div>}
                          </>}
