        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="w-30 h-30 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors bg-blue-100">
            ...
            <div className="text-center group">
              <div className="w-60 h-60 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors bg-blue-100">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-20 w-30">
