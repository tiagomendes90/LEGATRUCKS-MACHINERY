        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="w-40 h-40 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors bg-orange-50">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-20 w-30 ">
            ...
            <div className="text-center group">
              <div className="w-40 h-40 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors bg-orange-100">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-20 w-30">
            ...
            <div className="text-center group">
              ...
              <h3 className="font-semibold text-lg mb-2">TRACTORSV</h3>
              <p className="text-gray-600 text-base">Agricultural solutions designed to boost productivity.</p>
            </div>
            <div className="text-center group">
              <div className="w-40 h-40 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors bg-orange-100">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 32" className="h-20 w-30">
