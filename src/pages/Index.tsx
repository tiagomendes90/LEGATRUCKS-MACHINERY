        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <Link to="/trucks" className="text-center group cursor-pointer">
              <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 bg-orange-100 group-hover:bg-orange-300 group-hover:scale-110 group-hover:shadow-xl">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-12 w-18 transition-transform duration-300 group-hover:scale-110">
            ...
            <Link to="/contact" className="text-center group cursor-pointer">
              <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 bg-orange-100 group-hover:bg-orange-300 group-hover:scale-110 group-hover:shadow-xl">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 32" className="h-12 w-18 transition-transform duration-300 group-hover:scale-110">
