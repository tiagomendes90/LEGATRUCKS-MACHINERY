...
const getCategoryIcon = (categorySlug?: string) => {
  switch (categorySlug) {
    case 'trucks':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" focusable="false" aria-hidden="true" fill="none" className="h-6 w-6">
    ...
    <div className="w-full mb-8">
      ...
      <div className="bg-blue-50 rounded-lg p-6 mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-gray-600">{totalCount} oferta{totalCount !== 1 ? 's' : ''}</span>
        </div>
      </div>
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div>
              ...
              <Select 
                value={filters.priceTo || 'all'} 
                onValueChange={(value) => handleFilterChange('priceTo', value === 'all' ? '' : value)}
              >
                <SelectTrigger className="h-11">
            ...
            {/* Mileage/Hours */}
            <div>
              <Label htmlFor="mileage" className="text-sm font-medium text-gray-700 mb-2 block">
                Quilómetros máx.
              </Label>
              <Select>
                <SelectTrigger className="h-11">
