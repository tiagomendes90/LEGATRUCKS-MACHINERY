      ...
      <div className="relative flex items-center justify-center h-full px-6">
        <div className="flex flex-col items-center text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button asChild size="lg" className="bg-white/10 border-2 border-white text-white hover:bg-white hover:text-gray-900 text-lg px-8 py-6 rounded-xl shadow-lg backdrop-blur-sm">
